...
const STEPS: Step[] = [
  {
    emoji: '♠',
    title: 'WELCOME TO\nCHIP SOCIETY',
    desc: 'The premium Texas Hold\'em experience.\nVirtual chips only — no real money.',
    accent: '#00d4ff',
    gradFrom: '#001830',
  },
  {
  ...
  },
  {
    ...
    desc: 'Challenge 4 AI opponents at 5 difficulty\nlevels. Perfect your poker strategy.',
    accent: '#bf5fff',
    gradFrom: '#140020',
  },
  {
    emoji: '🎡',
    title: 'DAILY REWARDS',
    desc: 'Spin the wheel every 24 hours for free chips.\nScratch tickets unlock bonus prizes.',
    accent: '#00ff88',
    gradFrom: '#001a0a',
  },
  {
    ...
    desc: 'From Neon Bronze to Neon Legend.\nWin hands, complete achievements, dominate.',
    accent: '#ff0090',
    gradFrom: '#1a0010',
  },
  {
