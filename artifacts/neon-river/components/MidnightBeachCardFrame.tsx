/**
 * MidnightBeachCardFrame — Minimal Midnight Beach community card overlay.
...
export default function MidnightBeachCardFrame({ width, height }: Props) {
  ...
  return (
    ...
    >
      <Svg width={totalW} height={totalH} viewBox={`0 0 ${totalW} ${totalH}`}>
        ...
        <Flamingo ox={flamingoOX} oy={flamingoOY} s={flamingoS} color={PINK} op={0.88} />

        {/* ── Pink palm — right of frame ───────────────────────────────── */}
        <Palm cx={palmCX} baseY={palmBaseY} h={palmH} lean={-8} color={PINK} op={0.82} />
