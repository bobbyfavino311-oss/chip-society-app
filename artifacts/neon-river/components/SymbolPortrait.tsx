...
export const CLASSIC_SYMBOLS: ClassicSymbol[] = [
  ...
  { id: 10, label: 'GOLD DICE',    symbol: '⚅', color: '#00d4ff', bgColor: '#001a20' },
  { id: 11, label: 'CHROME ACE',   symbol: 'Ⓐ', color: '#4dc8ff', bgColor: '#000e20' },
  { id: 12, label: 'JACKPOT 777',  symbol: '7', color: '#ffd700', bgColor: '#1a1200' },
  { id: 13, label: 'HORSESHOE',    symbol: '∩', color: '#bf5fff', bgColor: '#150020' },
  { id: 14, label: 'SNAKE EYES',   symbol: '⚀', color: '#00ff88', bgColor: '#001a0a' },
  { id: 15, label: 'MIDNIGHT MARTINI', symbol: '♆', color: '#ff0090', bgColor: '#200010' },
  { id: 16, label: 'FLAMING CHIP', symbol: '◉', color: '#ff6600', bgColor: '#1a0800' },
  { id: 17, label: 'DIAMOND EYE',  symbol: '◈', color: '#00ffcc', bgColor: '#001a18' },
  { id: 18, label: 'MIDNIGHT CROWN',symbol: '♛', color: '#88ccff', bgColor: '#00101a' },
  { id: 19, label: 'ELEC JOKER',   symbol: 'Ψ', color: '#ff44aa', bgColor: '#1a0015' },
];
