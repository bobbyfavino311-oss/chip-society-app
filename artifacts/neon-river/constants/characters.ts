...
// Each character is rendered as a stylized cinematic portrait card using
// layered gradients, Orbitron typography, and SVG accents. No emoji.
...
export const CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    bio: 'The art form of misdirection. Crimson is the color of nerve.',
  ...
  {
    id: 76, name: 'The River Master', initials: 'RM', rarity: 'LEGENDARY', unlockXP: 420000,
    unlockCondition: 'Win 100 hands on the river',
    bio: 'The river card is his domain. Every session ends at the river.',
    portraitColors: ['#001809', '#004020', '#006b37'],
    lightColor: '#22ff99', accentColor: '#00ff88',
  },
  {
    id: 77, name: 'Neon Throne Holder', initials: 'NT', rarity: 'LEGENDARY', unlockXP: 440000,
    unlockCondition: 'Reach 440 000 XP',
    bio: 'The throne was always his. The neon burns for his reign.',
    portraitColors: ['#180030', '#3d0080', '#6200cc'],
    lightColor: '#cc22ff', accentColor: '#bb00ff',
  },
  {
    id: 78, name: 'The Midnight Emperor', initials: 'TE', rarity: 'LEGENDARY', unlockXP: 460000,
    unlockCondition: 'Reach level 75',
    bio: 'Darkness is his throne room. Midnight is his peak hour.',
    portraitColors: ['#000010', '#00003a', '#000064'],
    lightColor: '#4455ff', accentColor: '#4444ff',
  },
  {
    id: 79, name: 'Chip Society Founder', initials: 'CF', rarity: 'LEGENDARY', unlockXP: 480000,
    unlockCondition: 'Reach 480 000 XP',
    bio: 'Before the community, there was one player. This is him.',
    portraitColors: ['#1a1000', '#543200', '#8e5400'],
    lightColor: '#ffaa22', accentColor: '#ff9900',
  },
  {
    id: 80, name: 'The Poker Community Legend', initials: 'PL', rarity: 'LEGENDARY', unlockXP: 500000,
    unlockCondition: 'Reach level 80 — The Pinnacle',
    bio: 'The rarest character. The highest prestige. The community legend.',
    portraitColors: ['#0a0020', '#1e0060', '#3200a0'],
    lightColor: '#ee22ff', accentColor: '#ff00ff',
  },
];
