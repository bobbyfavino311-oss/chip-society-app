...
export const CHARACTERS: Character[] = [
  ...
  {
    id: 3, name: 'The Waitress', initials: 'WA', rarity: 'COMMON', unlockXP: 0,
    unlockCondition: 'Available from the start',
  ...
  {
    id: 4, name: 'The College Grinder', initials: 'CG', rarity: 'COMMON', unlockXP: 0,
    unlockCondition: 'Available from the start',
  ...
  {
    id: 5, name: 'The Club Promoter', initials: 'CP', rarity: 'COMMON', unlockXP: 0,
    unlockCondition: 'Available from the start',
  ...
  {
    id: 6, name: 'The Poker Blogger', initials: 'PB', rarity: 'COMMON', unlockXP: 0,
    unlockCondition: 'Available from the start',
  ...
  {
    id: 7, name: 'The Local Regular', initials: 'LR', rarity: 'COMMON', unlockXP: 0,
    unlockCondition: 'Available from the start',
  ...
  {
    id: 8, name: 'The Side Hustler', initials: 'SH', rarity: 'COMMON', unlockXP: 0,
    unlockCondition: 'Available from the start',
  ...
  {
    id: 9, name: 'The Bartender', initials: 'BT', rarity: 'COMMON', unlockXP: 0,
    unlockCondition: 'Available from the start',
  ...
  {
    id: 10, name: 'The Weekend Warrior', initials: 'WW', rarity: 'COMMON', unlockXP: 0,
    unlockCondition: 'Available from the start',
