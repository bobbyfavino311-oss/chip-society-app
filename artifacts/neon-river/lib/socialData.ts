...
export const MOCK_PLAYERS: MockPlayer[] = [
  ...
  },
  {
    ...
    bio: 'Reading souls across the felt. Your tells are showing. Ice queen of the felt.',
  },
  {
...
export const SOCIAL_POSTS: SocialPost[] = [
  ...
  },
  {
    ...
    content: 'Six-hour grind session, up 8 buy-ins. Patience and position. This is what the game is about.',
    pot: '15,000', likes: 432, comments: 56,
    reactions: { fire: 320, spade: 100, money: 180, wow: 220, crown: 280 },
    timeAgo: '12h', tab: 'trending',
  },
  {
  ...
  {
    id: 'sp9', playerId: 'p9', tag: 'JACKPOT',
    content: 'Lucky wheel hit the 1M jackpot. Ice in the veins, fire in the chips. 👑 The whole lobby erupted.',
    pot: '1,000,000', handRank: 'Jackpot', likes: 3200, comments: 480,
